...
export function StickyMobileBar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 border-t border-line bg-white/95 px-4 py-3 shadow-[0_-10px_30px_-20px_rgba(44,74,67,0.45)] backdrop-blur lg:hidden">
